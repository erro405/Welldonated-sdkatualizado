            ...
            children: [
              ...
              TextFormField(
                ...
                decoration: InputDecoration(
                  ...
                  errorText: _addressValid ? 'Localidade não pode ficar em branco' : null,
                ),
                style: TextStyle(
                  color: Colors.white,
                  fontSize: 20.0,
              ...
              TextFormField(
                ...
                decoration: InputDecoration(
                  ...
                  errorText: _phoneNoValid ? 'Contacto não pode ficar em branco' : null,
                ),
                style: TextStyle(
                  color: Colors.white,
                  fontSize: 20.0,
              ...
              ElevatedButton(
                onPressed: () async {
                  if (imageFile == null) {
                    ...
                    return;
                  } else if (_nameController.text.isEmpty || _emailTextController.text.isEmpty || _phoneNumController.text.isEmpty || _addressTextController.text.isEmpty || _passwordController.text.isEmpty) {
                    setState(() {
                      _nameController.text.isEmpty ? _nameValid = true : _nameValid = false;
                      ...
                      _addressTextController.text.isEmpty ? _addressValid = true : _addressValid = false;
